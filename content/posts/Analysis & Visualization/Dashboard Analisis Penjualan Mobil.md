...
draft = false
description = ""
image = "/images/Analysis_and_Visualization/Dashboard_Analisis_Penjualan_Mobil/2.webp"
imageBig= "/images/Analysis_and_Visualization/Dashboard_Analisis_Penjualan_Mobil/2.webp"
...
  <img src="/images/Analysis_and_Visualization/Dashboard_Analisis_Penjualan_Mobil/2.webp" alt="Halaman Overview Dashboard Penjualan Mobil" style="width:100%; max-width:700px; display:block; margin:auto; border: 1px solid #333;">
  <p style="font-size: 16px; color: #888; margin-top:5px; text-align: center;">Halaman 'Overview' menampilkan ringkasan visual dari metrik penjualan utama dan analisis berdasarkan berbagai kategori.</p>
</div>
<br>
<div class="single-image-source">
  <img src="/images/Analysis_and_Visualization/Dashboard_Analisis_Penjualan_Mobil/1.webp" alt="Halaman Detail Transaksi Penjualan Mobil" style="width:100%; max-width:700px; display:block; margin:auto; border: 1px solid #333;">
  <p style="font-size: 16px; color: #888; margin-top:5px; text-align: center;">Halaman 'Details' memungkinkan pengguna untuk melihat data transaksional mentah untuk analisis yang lebih mendalam.</p>
</div>