...
  <img src="1.webp" alt="Halaman Utama Laporan Penjualan Pizza" style="width:100%; max-width:700px; display:block; margin:auto; border: 1px solid #ddd;">
  <p style="font-size: 16px; color: #888; margin-top:5px; text-align: center;">Halaman utama 'Home' yang menampilkan ringkasan performa penjualan, tren pemesanan, dan analisis berdasarkan kategori serta ukuran pizza.</p>
</div>
<br>
<div class="single-image-source">
  <img src="2.webp" alt="Analisis Produk Terlaris dan Kurang Laris pada Penjualan Pizza" style="width:100%; max-width:700px; display:block; margin:auto; border: 1px solid #ddd;">
  <p style="font-size: 16px; color: #888; margin-top:5px; text-align: center;">Halaman 'Best/Worst Sellers' yang memberikan peringkat produk teratas dan terbawah untuk membantu dalam optimasi menu.</p>
</div>