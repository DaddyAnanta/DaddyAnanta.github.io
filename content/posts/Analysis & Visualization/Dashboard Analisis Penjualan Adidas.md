...
draft = false
description = ""
image = "/images/Analysis_and_Visualization/Dashboard_Analisis_Penjualan_Adidas/1.webp"
imageBig= "/images/Analysis_and_Visualization/Dashboard_Analisis_Penjualan_Adidas/1.webp"
...
  <img src="/images/Analysis_and_Visualization/Dashboard_Analisis_Penjualan_Adidas/1.webp" alt="Dashboard Analisis Penjualan Adidas" style="width:100%; max-width:700px; display:block; margin:auto; border: 1px solid #ddd;">
  <p style="font-size: 16px; color: #888; margin-top:5px; text-align: center;">Tampilan dashboard utama yang merangkum metrik penjualan, profitabilitas, dan distribusi produk Adidas di berbagai wilayah.</p>
</div>