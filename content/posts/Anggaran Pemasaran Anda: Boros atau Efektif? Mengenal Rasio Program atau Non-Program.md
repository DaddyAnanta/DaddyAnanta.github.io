+++
title = 'Anggaran Pemasaran Anda: Boros atau Efektif? Mengenal Rasio Program/Non-Program'
...
<div class="single-image-source">
  <img src="/images/34.Anggaran_Pemasaran_Anda:_Boros_atau_Efektif_Mengenal_Rasio_Program_Non-Program/2.png" alt="Apa Sebenarnya Gross Margin Itu?" style="height:80%;width:80%;display:block;margin-left:auto;margin-right:auto;">
  <p style="font-size: 16px; color: #888; margin-top:-15px; text-align: center;"> Mana yang Menciptakan Nilai Langsung? From Imagen 3</p>
</div>
...
<div class="single-code" style="width: 100%; font: inherit; background-color: #f9f9f9; border:1px solid #ccc; color: #333; padding: 10px; border-radius: 5px; margin-bottom:20px; word-wrap: break-word; overflow-wrap: break-word; max-height: 200px; overflow-y: auto;">
  <p>$$\text{PNPR} = \frac{\text{Total Biaya Program}}{\text{Total Pengeluaran Pemasaran}} = \frac{\text{Rp 70.000.000}}{\text{Rp 100.000.000}} ​= 0.7 \text{ atau 70} \%  $$</p>
</div>
...
<div class="single-image-source">
  <img src="/images/34.Anggaran_Pemasaran_Anda:_Boros_atau_Efektif_Mengenal_Rasio_Program_Non-Program/3.png" alt="Apa Sebenarnya Gross Margin Itu?" style="height:80%;width:80%;display:block;margin-left:auto;margin-right:auto;">
  <p style="font-size: 16px; color: #888; margin-top:-15px; text-align: center;"> Mendefinisikan Batasan yang Jelas From Imagen 3</p>
</div>
