...
<div class="single-image-source">
  <img src="3.webp" alt="Trik Praktis Uji Hipotesis Satu Arah" style="height:80%;width:80%;display:block;margin-left:auto;margin-right:auto;"><p style="font-size: 16px; color: #888; margin-top:-15px; text-align: center;">Digg v4 from Google Search
</p>
</div>
