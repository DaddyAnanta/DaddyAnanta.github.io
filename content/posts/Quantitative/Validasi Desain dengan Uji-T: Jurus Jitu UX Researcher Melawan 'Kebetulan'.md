...
socialshare = true
description = ""
image = "/images/Quantitative/Validasi_Desain_dengan_Uji-T:_Jurus_Jitu_UX_Researcher_Melawan_'Kebetulan'/1.webp"
imageBig= "/images/Quantitative/Validasi_Desain_dengan_Uji-T:_Jurus_Jitu_UX_Researcher_Melawan_'Kebetulan'/1.webp"
...
<div class="single-image-source">
  <img src="/images/Quantitative/Validasi_Desain_dengan_Uji-T:_Jurus_Jitu_UX_Researcher_Melawan_'Kebetulan'/2.webp" alt="Kerangka OODA Loop Memetakan Jalan dari Data ke Keputusan" style="height:80%;width:80%;display:block;margin-left:auto;margin-right:auto;">
  <p style="font-size: 16px; color: #888; margin-top:-15px; text-align: center;"> OODA Loops from James O'Leary in<a href="https://medium.com/@james_footium/ooda-loops-and-decision-making-6bdedd1f2431"> Medium</a></p>
</div>
...
<div class="single-image-source">
  <img src="/images/Quantitative/Validasi_Desain_dengan_Uji-T:_Jurus_Jitu_UX_Researcher_Melawan_'Kebetulan'/4.webp" alt="Validasi Desain Pencarian di Microsoft Windows" style="height:40%;width:40%;display:block;margin-left:auto;margin-right:auto;">
  <p style="font-size: 16px; color: #888; margin-top:-15px; text-align: center;"> Windows Vista in<a href="https://jv.wikipedia.org/wiki/Windows_Vista"> Wikipedia</a></p>
</div>
...
<div class="youtube1" style="text-align: center;margin-bottom : 30px;" >
    <iframe width="80%" height="100%" item-align="center"  src=https://www.youtube.com/embed/tR847eIONnc?si=hZYDPDgGYplhFgFq" 
...
<div class="single-image-source">
  <img src="/images/Quantitative/Validasi_Desain_dengan_Uji-T:_Jurus_Jitu_UX_Researcher_Melawan_'Kebetulan'/3.webp" alt="Validasi Desain Pencarian di Microsoft Windows" style="height:80%;width:80%;display:block;margin-left:auto;margin-right:auto;">
  <p style="font-size: 16px; color: #888; margin-top:-15px; text-align: center;">Image from Imagen 3</a></p>
</div>
