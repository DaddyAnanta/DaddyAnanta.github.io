...
socialshare = true
description = ""
image = "/images/Quantitative/Metode_Pengambilan_Sample_Berdasarkan_Populasi_(Sampling_Size)/1.webp"
imageBig= "/images/Quantitative/Metode_Pengambilan_Sample_Berdasarkan_Populasi_(Sampling_Size)/1.webp"
...
<img src="/images/Quantitative/Metode_Pengambilan_Sample_Berdasarkan_Populasi_(Sampling_Size)/2.webp" alt="Tabel penentuan ukuran sampel Issac & Michael" style="height:100%; width:60%; display:block; margin:auto;">
...
<figure class="single-image-source" style="text-align: center; margin: 0 auto;">
  <img src="/images/Quantitative/Metode_Pengambilan_Sample_Berdasarkan_Populasi_(Sampling_Size)/3.webp" alt="Contoh penggunaan tabel Isaac & Michael" style="height:100%; width:70%; display:block; margin:auto;">
