+++
title = 'Mengukur Efisiensi Pemasaran dengan Rasio Program/Gaji'
...
<div class="single-image-source">
  <img src="/images/35.Mengukur_Efisiensi_Pemasaran_dengan_Rasio_Program_Gaji/2.png" style="height:80%;width:80%;display:block;margin-left:auto;margin-right:auto;" alt="PPR: Membandingkan Aksi Pemasaran dengan Biaya Tim
">
  <p style="font-size: 16px; color: #888; margin-top:-15px; text-align: center;">PPR: Membandingkan Aksi Pemasaran dengan Biaya Tim From Imagen 3
</p>
</div>

Berbeda dengan <a href="https://daddyananta.github.io/posts/anggaran-pemasaran-anda-boros-atau-efektif-mengenal-rasio-program-atau-non-program/">PNPR</a> yang melihat biaya program dibandingkan _seluruh_ biaya pendukung, PPR secara khusus membandingkan jumlah dana yang kita habiskan untuk **aktivitas program pemasaran** (iklan, promosi, konten, acara—aktivitas yang langsung menyentuh pasar) dengan jumlah dana yang kita keluarkan untuk **penggajian tim pemasaran** (gaji, tunjangan, dan biaya terkait lainnya untuk orang-orang yang menjalankan atau mendukung program tersebut).
...
<div class="single-code" style="width: 100%; font: inherit; background-color: #f9f9f9; border:1px solid #ccc; color: #333; padding: 10px; border-radius: 5px; margin-bottom:20px; word-wrap: break-word; overflow-wrap: break-word; max-height: 200px; overflow-y: auto;">
  <p>$$\text{PPR} = \frac{\text{Dana yang Dibelanjakan untuk Program Pemasaran​}}{\text{Dana yang Dibelanjakan untuk Gaji Pemasaran}}$$</p>
</div>
...
- **Biaya Program (Total Rp 200 juta):**
    ...
    - Pembuatan e-book gratis sebagai _lead magnet_ (Rp 15 juta)
...
<div class="single-code" style="width: 100%; font: inherit; background-color: #f9f9f9; border:1px solid #ccc; color: #333; padding: 10px; border-radius: 5px; margin-bottom:20px; word-wrap: break-word; overflow-wrap: break-word; max-height: 200px; overflow-y: auto;">
  <p>$$\text{PPR} = \frac{\text{Rp 200.000.000​}}{\text{Rp 250.000.000}} = 0.8 \text{ atau 80} \% $$
</p>
</div>
...
<div class="single-image-source">
  <img src="/images/35.Mengukur_Efisiensi_Pemasaran_dengan_Rasio_Program_Gaji/3.png" style="height:80%;width:80%;display:block;margin-left:auto;margin-right:auto;" alt="Interpretasi yang Cermat dan Potensi Jebakan">
  <p style="font-size: 16px; color: #888; margin-top:-15px; text-align: center;">Interpretasi yang Cermat dan Potensi Jebakan From Imagen 3
</p>
</div>
...
Rasio Program/Gaji (PPR) bukanlah pengganti <a href="https://daddyananta.github.io/posts/anggaran-pemasaran-anda-boros-atau-efektif-mengenal-rasio-program-atau-non-program/">PNPR</a>, melainkan pelengkap yang memberikan sudut pandang lebih tajam pada salah satu elemen biaya terbesar: orang. Dengan membandingkan investasi pada program pemasaran langsung dengan investasi pada tim yang menjalankannya, kita mendapatkan wawasan berharga tentang alokasi sumber daya manusia dalam fungsi pemasaran.
