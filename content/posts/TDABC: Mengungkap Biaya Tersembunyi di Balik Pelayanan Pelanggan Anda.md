+++
title = 'TDABC: Mengungkap Biaya Tersembunyi di Balik Pelayanan Pelanggan Anda'
...
<div class="single-code" style="width: 100%; font: inherit; background-color: #f9f9f9; border:1px solid #ccc; color: #333; padding: 10px; border-radius: 5px; margin-bottom:20px; word-wrap: break-word; overflow-wrap: break-word; max-height: 200px; overflow-y: auto;"><p>$$TC = C_h ​\times T_u​$$</p></div>
...
<p>$$TC = C_h \times T_u$$</p>
<p>$$​TC= \text{Rp 300.000} per jam \times 1.25 jam$$</p>
<p>$$TC= \text{Rp 375.000}$$</p></div>

Jadi, biaya _sebenarnya_ yang dikeluarkan oleh Kreasi Medan untuk mengerjakan revisi tambahan tersebut adalah **Rp 375.000**. Angka ini mungkin tidak terlihat jika mereka hanya menghitung biaya berdasarkan harga proyek awal.
