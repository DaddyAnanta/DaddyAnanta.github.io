+++
title = 'Kartu Skor Merek: Menilai Kesehatan Aset'
...
<div class="single-image-source">
  <img src="/images/37.Kartu_Skor_Merek_Menilai_Kesehatan_Aset/2.png" style="height:80%;width:80%;display:block;margin-left:auto;margin-right:auto;" alt="Pangsa Pasar dalam Rencana Bisnis Anda">
  <p style="font-size: 16px; color: #888; margin-top:-15px; text-align: center;">Mengukur Kekuatan From Imagen 3</p>
</div>
...
<div class="single-image-source">
  <img src="/images/37.Kartu_Skor_Merek_Menilai_Kesehatan_Aset/3.png" style="height:80%;width:80%;display:block;margin-left:auto;margin-right:auto;" alt="Mengidentifikasi Risiko">
  <p style="font-size: 16px; color: #888; margin-top:-15px; text-align: center;">Mengidentifikasi Risiko From Imagen 3</p>
</div>
...
<div class="single-code" style="width: 100%; font: inherit; background-color: #f9f9f9; border:1px solid #ccc; color: #333; padding: 10px; border-radius: 5px; margin-bottom:20px; word-wrap: break-word; overflow-wrap: break-word; max-height: 200px; overflow-y: auto;">
  <p>$$\text{Skor Ekuitas Merek (Relatif)} = \text{Total Skor Aset Merek​​} - \text{Total Skor Kewajiban Merek} $$
</p>
</div>
...
<div class="single-image-source">
  <img src="/images/37.Kartu_Skor_Merek_Menilai_Kesehatan_Aset/4.png" style="height:80%;width:80%;display:block;margin-left:auto;margin-right:auto;" alt="Manfaat dan Tantangan Kartu Skor">
  <p style="font-size: 16px; color: #888; margin-top:-15px; text-align: center;">Manfaat dan Tantangan Kartu Skor From Imagen 3</p>
</div>
