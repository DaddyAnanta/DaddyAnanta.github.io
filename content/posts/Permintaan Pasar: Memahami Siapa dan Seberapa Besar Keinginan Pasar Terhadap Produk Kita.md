+++
title = 'Permintaan Pasar: Memahami Siapa dan Seberapa Besar Keinginan Pasar Terhadap Produk Kita'
...
<div class="single-image-source">
  <img src="/images/32.Permintaan_Pasar:_Memahami_Siapa_dan_Seberapa_Besar_Keinginan_Pasar_Terhadap_Produk_Kita/2.png" alt="Apa Sebenarnya Permintaan Pasar Itu?" style="height:80%;width:80%;display:block;margin-left:auto;margin-right:auto;">
...
<p>$$\text{Permintaan Pasar(Total)} = \text{Permintaan dari Pelanggan Lama(Berulang)} + \text{Permintaan dari Pelanggan Baru}$$</p>
<p>$$ M_{dt} ​= P_{rt} ​+ P_{nt}​$$</p></div>
...
<div class="single-image-source">
  <img src="/images/32.Permintaan_Pasar:_Memahami_Siapa_dan_Seberapa_Besar_Keinginan_Pasar_Terhadap_Produk_Kita/3.png" alt="Mengapa Memahami Permintaan Pasar Ini Penting Bagi Kita?" style="height:80%;width:80%;display:block;margin-left:auto;margin-right:auto;">
  <p style="font-size: 16px; color: #888; margin-top:-15px; text-align: center;">Mengapa Memahami Permintaan Pasar Ini Penting Bagi Kita?</p>
</div>
...
<div class="single-image-source">
  <img src="/images/32.Permintaan_Pasar:_Memahami_Siapa_dan_Seberapa_Besar_Keinginan_Pasar_Terhadap_Produk_Kita/4.png" alt="Dari Mana Kita Mendapatkan Datanya?" style="height:80%;width:80%;display:block;margin-left:auto;margin-right:auto;">
  <p style="font-size: 16px; color: #888; margin-top:-15px; text-align: center;">Dari Mana Kita Mendapatkan Datanya?</p>
</div>
